export function Header({ setBackToDefault, isDarkMode, setIsDarkMode }) {
  ...
  return (
    <header>
      <button className="logo" onClick={handleDefault}>
        devfinder
      </button>
      <div className="mode-switch" onClick={handleClick}>
        <div className="switch-name">{!isDarkMode ? "dark" : "light"}</div>
