export function Location({ data, defaultUser, backToDefault, error }) {
  return (
    <>
      {data != "" && backToDefault != true && !error ? (
        <div className="location location-one">
          <div
            className={data.location ? "location-row" : "location-notavailable"}
          >
            <svg
              height="20"
              width="14"
              className="location-icon location-pin"
              alt="location icon"
            ...
            {data.location != null ? (
              <div className="location-content">{data.location}</div>
            ) : (
              <div className="not-available">Not Available</div>
            )}
          </div>
          <div className={data.blog ? "location-row" : "location-notavailable"}>
            <svg
              height="20"
              width="20"
              className="location-icon location-link"
              xmlns="http://www.w3.org/2000/svg"
              alt="link icon"
            >
              <g fill="#4b6a9b">
          ...
          <div
            className={
              data.twitter_username ? "location-row" : "location-notavailable"
            }
          >
            <svg
              height="18"
              width="20"
              className="location-icon location-twitter"
              alt="twitter icon"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
            ...
            {data.twitter_username != null ? (
              <div className="location-content">{data.twitter_username}</div>
            ) : (
              <div className="not-available">Not Available</div>
            )}
          </div>
          <div
            className={data.company ? "location-row" : "location-notavailable"}
          >
            <svg
              height="20"
              width="20"
              className="location-icon location-company"
              alt="company icon"
              xmlns="http://www.w3.org/2000/svg"
            >
              <g fill="#4b6a9b">
            ...
            {data.company != null ? (
              <div className="location-content">{data.company}</div>
            ) : (
              <div className="not-available">Not Available</div>
            )}
          </div>
        ...
        <div className="location">
          <div
            className={
              defaultUser.location ? "location-row" : "location-notavailable"
            }
          >
            <svg
              height="20"
            ...
            <div className="location-content">{defaultUser.location}</div>
          </div>
          <div
            className={
              defaultUser.blog ? "location-row" : "location-notavailable"
            }
          >
            <svg
              height="20"
            ...
            <div className="location-content">
              <a href={defaultUser.blog} target="_blank">
                {defaultUser.blog}
              </a>
            </div>
          </div>
          {defaultUser.twitter_username != null ? (
            <div
              className={
            ...
            >
              ...
              <div className="location-content">Not Available</div>
            </div>
          )}

          <div
            className={
              defaultUser.company ? "location-row" : "location-notavailable"
            }
          >
            <svg
              height="20"
            ...
            <div className="location-content">{defaultUser.company}</div>
          </div>
        </div>
      )}
    </>
